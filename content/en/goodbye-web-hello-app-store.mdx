...
> **⚡ Important Update:** As of May 2026, Spendly is officially transitioning. We have frozen the web version (PWA) to focus 100% of our resources on a native iOS app. [Join the Waitlist](#waitlist) to be the first to know when we launch in the App Store.
...
[Join the iOS Waitlist for Summer 2026 →](#waitlist)